      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="customer-name">Full Name(s) *</Label>
            <Input
              id="customer-name"
          ...
          <div className="space-y-2">
            <Label htmlFor="billing-address">Billing Address (for receipt purposes)</Label>
            <Textarea
              id="billing-address"
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Street address, city, state, ZIP (leave blank if same as billing)"
